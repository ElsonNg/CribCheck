...
export default function SelectLocationScreen() {
    ...
    return (<div className="animate-fadeInUp w-[95%] md:w-[90%] flex flex-col gap-2">
        <div className="flex flex-col">
            ...
            <p className="font-medium">Crib Check rates the quality of your crib{"'"}s location based solely on the amenities available.<br/>Choose a location then select your criteria and we will rate the location based on publicly available government data!</p>
